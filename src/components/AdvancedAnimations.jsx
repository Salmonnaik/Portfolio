      ...
      animate={{
        background: theme === 'dark' 
          ? [
            ...
            'linear-gradient(45deg, #f5576c 0%, #667eea 25%, #764ba2 50%, #f093fb 75%, #f5576c 100%)',
            'linear-gradient(45deg, #764ba2 0%, #f093fb 25%, #f5576c 50%, #667eea 75%, #764ba2 100%)'
          ]
          : [
            'linear-gradient(45deg, #3b82f6 0%, #8b5cf6 25%, #ec4899 50%, #f59e0b 75%, #3b82f6 100%)',
            'linear-gradient(45deg, #ec4899 0%, #f59e0b 25%, #3b82f6 50%, #8b5cf6 75%, #ec4899 100%)',
            'linear-gradient(45deg, #f59e0b 0%, #3b82f6 25%, #8b5cf6 50%, #ec4899 75%, #f59e0b 100%)',
            'linear-gradient(45deg, #8b5cf6 0%, #ec4899 25%, #f59e0b 50%, #3b82f6 75%, #8b5cf6 100%)'
          ]
        ],
...
// Morph Button
export const MorphButton = ({ children, onClick, className = '' }) => {
